...
/**
 * Typical "Shakespeare" example of SOLR indexation but this one makes use of Pangool's facilities to
 * create multiple indexes from the same indexer Job. When given an (uncompressed) shakespeare dump folder like: 
