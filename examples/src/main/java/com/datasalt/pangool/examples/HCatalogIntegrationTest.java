  ...
  public int run(String[] args) throws Exception {
  	// Re. environment variables: http://incubator.apache.org/hcatalog/docs/r0.4.0/inputoutput.html
		if(args.length != 2) {
            ...
            System.out.println("Usage: HCatTupleInputFormat dbName tableName filter");
            System.out.println();
			System.out.println();
        ...
        builder.addInput(new Path("anything"), new HCatTupleInputFormat(dbName, tableName, conf, filter), new MapOnlyMapper<ITuple, NullWritable, NullWritable, NullWritable>() {
