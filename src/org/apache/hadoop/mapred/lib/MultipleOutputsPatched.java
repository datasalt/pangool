 ...
 * group is the {@link MultipleOutputsPatched} class name.
 * </p>
...
public class MultipleOutputsPatched {
   ...
   */
  public MultipleOutputsPatched(JobConf job) {
    this.conf = job;
    outputFormat = new InternalFileOutputFormat();
    namedOutputs = Collections.unmodifiableSet(
      new HashSet<String>(MultipleOutputsPatched.getNamedOutputsList(job)));
