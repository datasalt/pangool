 ...
 * 
 * @param <E>
 *          Object type that is to be inserted into the Bloom filter, e.g. String or Integer.
...
public class BloomFilter<E> implements Serializable {
  ...
  private static final long serialVersionUID = 1L;
	...
	static final String hashName = "MD5"; // MD5 gives good enough accuracy in most circumstances. Change to SHA1 if it's
																				// needed
	...
	/**
	 * Constructs an empty Bloom filter. The optimal number of hash functions (k) is estimated from the total size of the
	...
	/**
	 * Constructs an empty Bloom filter with a given false positive probability. The number of bits per element and the
	 * number of hash functions is estimated to match the false positive probability.
	 * 
	 ...
	 * <br />
	 * K is the optimal number of hash functions based on the size of the Bloom filter and the expected number of inserted
	 * elements.
	 * 
	 * @return optimal k.
	 */
