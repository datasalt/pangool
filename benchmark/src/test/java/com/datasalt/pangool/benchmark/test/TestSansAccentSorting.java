...
public class TestSansAccentSorting extends BaseBenchmarkTest {
	...
	private final static String EXPECTED_OUTPUT = INPUT_FOLDER + "/spanish_alphabetic_order.txt";

	private final static String OUTPUT_FOLDER = "/tmp";
	private final static String OUT_REPEATING = OUTPUT_FOLDER + "/out-sansaccent-repeating";
