...
public class TestGrouperWithRollup extends AbstractHadoopTestLibrary {
	...
	private static class IdentityRed extends GroupHandlerWithRollup<Text, Text> {
		...
		@Override
		public void setup(State state, ReduceContext context) throws IOException, InterruptedException {
		}

		@Override
		public void cleanup(State state, ReduceContext context) throws IOException, InterruptedException {
		}

		@SuppressWarnings("unchecked")
		@Override
		public void onOpenGroup(int depth, String field, ITuple firstElement, State state, ReduceContext context)
		...
		@SuppressWarnings("unchecked")
		@Override
		public void onCloseGroup(int depth, String field, ITuple lastElement, State state, ReduceContext context)
		    throws IOException, InterruptedException {
	...
	@Test
	public void test() throws IOException, InterruptedException, ClassNotFoundException, InstantiationException,
