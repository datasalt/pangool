...
////		
////				PangoolSchema.setInConfig(SCHEMA, getConf());
////	}
//	
////	/**
...
////	 * 
////	 */
////	public static void fillTuple(boolean isRandom,PangoolSchema schema,ITuple tuple, int minIndex, int maxIndex) {
////		try {
////			Random random = new Random(randomSeed);
////			//PangoolSchema schema = tuple.getSchema();
