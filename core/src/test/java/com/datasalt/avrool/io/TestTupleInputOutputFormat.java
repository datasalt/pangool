...
//
//		PangoolSchema pangoolSchema = PangoolSchema.parse("title:string, content:string");
//		CoGrouperConfigBuilder configBuilder = new CoGrouperConfigBuilder();
//		configBuilder.addSource(0, pangoolSchema);
...
//		coGrouper.setTupleOutput(outPath, pangoolSchema); // setTupleOutput method
