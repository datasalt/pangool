...
//		SCHEMA = PangoolSchema.parse("int_field:int," + "long_field:long," + "vint_field:vint," + "vlong_field:vlong,"
...
//	 * 
//	 */
//	protected static void fillTuple(boolean isRandom, PangoolSchema pangoolSchema, ITuple tuple, int minIndex, int maxIndex) {
//		try {
