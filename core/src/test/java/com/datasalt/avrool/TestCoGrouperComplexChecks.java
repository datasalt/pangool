...
//			.addSource(1, PangoolSchema.parse("url:string, date:long, fetched:long, content:string"))
//		  .addSource(2, PangoolSchema.parse("url:string, date:long, fetched:long, name:string, surname:string"))
//		  .setSorting(sorting)
