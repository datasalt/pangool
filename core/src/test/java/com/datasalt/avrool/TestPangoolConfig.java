...
//
//		configBuilder.addSource(0, PangoolSchema.parse("url:string, fetched:long, content:string"));
//		configBuilder.addSource(1, PangoolSchema.parse("url:string, fetched:vlong, name:string"));
...
//		CoGrouperConfigBuilder configBuilder = new CoGrouperConfigBuilder();
//
//		configBuilder.addSource(0, PangoolSchema.parse("url:string, date:long, fetched:long, content:string"));
...
//
//		configBuilder.addSource(0, PangoolSchema.parse("url:string, date:long, fetched:long, content:string"));
//		configBuilder.addSource(1, PangoolSchema.parse("fetched:long, url:string, name:string"));
...
//
//		configBuilder.addSource(0, PangoolSchema.parse("url:string, date:long, fetched:long, content:string"));
//		configBuilder.addSource(1, PangoolSchema.parse("fetched:vlong, url:string, name:string"));
//		configBuilder.setSorting(new SortingBuilder().add("url", SortOrder.DESC).addSourceId(SortOrder.ASC)
...
//		
//		Assert.assertEquals(PangoolSchema.parse("url:string, " + Field.SOURCE_ID_FIELD_NAME + ":vint").toString(),
//		    config.getCommonOrderedSchema().toString());
//		Assert.assertEquals(PangoolSchema.parse("content:string, date:long, fetched:long").toString(), config.getSpecificOrderedSchemas().get(0).toString());
//		Assert.assertEquals(PangoolSchema.parse("fetched:vlong, name:string").toString(), config.getSpecificOrderedSchemas().get(1).toString());
//	}
//
//	@Test
...
//		CoGrouperConfig config = configBuilder.build();
//
//		Assert.assertEquals(PangoolSchema.parse("url:string, fetched:long, " + Field.SOURCE_ID_FIELD_NAME + ":vint").toString(),
//		    config.getCommonOrderedSchema().toString());
//		Assert.assertEquals(PangoolSchema.parse("content:string, date:long").toString(),
//		    config.getSpecificOrderedSchemas().get(0).toString());
//		Assert.assertEquals(PangoolSchema.parse("name:string").toString(),
...
//		CoGrouperConfig config = configBuilder.build();
//
//		Assert.assertEquals(PangoolSchema.parse("url:string, " + Field.SOURCE_ID_FIELD_NAME + ":vint" + ", fetched:long").toString(),
//		    config.getCommonOrderedSchema().toString());
//		Assert.assertEquals(PangoolSchema.parse("content:string, date:long").toString(),
//		    config.getSpecificOrderedSchemas().get(0).toString());
//		Assert.assertEquals(PangoolSchema.parse("name:string").toString(),
...
//
//		configBuilder.addSource(1, builder1.createSchema());
//		configBuilder.addSource(2, builder2.createSchema());
