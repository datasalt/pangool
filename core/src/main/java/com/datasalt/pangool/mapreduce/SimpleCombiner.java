...
public class SimpleCombiner extends Reducer<PangoolWrapper<ITuple>, NullWritable,PangoolWrapper<ITuple>, NullWritable> {
	...
	private TupleIterator<PangoolWrapper<ITuple>, NullWritable> grouperIterator;
	...
	public void setup(Context context) throws IOException, InterruptedException {
		...
		try {
			...
			this.grouperIterator = new TupleIterator<PangoolWrapper<ITuple>, NullWritable>(context);
