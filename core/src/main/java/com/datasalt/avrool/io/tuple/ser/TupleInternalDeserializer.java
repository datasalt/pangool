...
//import com.datasalt.avrool.io.Buffer;
...
//		}
//		t.clear();
//		PangoolSchema commonSchema = pangoolConf.getCommonOrderedSchema();
//		readFields(commonSchema, t, in);
//		PangoolSchema specificSchema = pangoolConf.getSpecificOrderedSchema(pangoolConf.getSourceId(t));
//		readFields(specificSchema, t, in);
//		return t;
//	}
//
//	public void readFields(PangoolSchema pangoolSchema, ITupleInternal tuple, DataInput input) throws IOException {
//		for(int i = 0; i < pangoolSchema.getFields().size(); i++) {
//			Class<?> fieldType = pangoolSchema.getField(i).getType();
//			String fieldName = pangoolSchema.getField(i).getName();
