...
//	}
//
//	public int write(PangoolSchema pangoolSchema, ITupleInternal tuple, DataOutput output) throws IOException {
//		int presentFields = 0;
...
//	}
//
//	private void raiseExceptionWrongFields(PangoolSchema pangoolSchema, ITupleInternal tuple) throws IOException {
//		List<String> wrongFields = new ArrayList<String>();
//		for(String field : tuple.keySet()) {
//			if(!pangoolSchema.containsFieldName(field)) {
//				wrongFields.add(field);
//			}
//		}
//		String fieldsConcated = concat(wrongFields, ",");
//		throw new IOException("Tuple contains fields that don't belong to schema: [" + fieldsConcated + "]. PangoolSchema: ["
//		    + pangoolSchema + "]");
//	}
//
