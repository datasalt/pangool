...
//	protected PangoolSchema commonSchema;
//	
...
//			PangoolSchema particularSchema = config.getSpecificOrderedSchemas().get(firstSourceId);
...
//	public int compare(int numFieldsToCompare, PangoolSchema pangoolSchema, SortCriteria sortCriteria, ITuple tuple1, ITuple tuple2) {
//		
//		for(int depth = 0; depth < numFieldsToCompare; depth++) {
//			Field field = pangoolSchema.getField(depth);
...
//		PangoolSchema commonSchema = config.getCommonOrderedSchema();
//		int fieldsToCompare = commonCriteria.getSortElements().length;		
//
...
//	 * 
//	 */
//	public int compare(int fieldsToCompare, PangoolSchema pangoolSchema, SortCriteria sortCriteria, byte[] b1, int s1, int l1, byte[] b2, int s2, int l2) {
//
//		try {
//			offset1 = s1;
//			offset2 = s2;
//			for(int depth = 0; depth < fieldsToCompare; depth++) {
//				Field field = pangoolSchema.getFields().get(depth);
